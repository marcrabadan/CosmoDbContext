...
namespace CosmosDbFramework
{
    public interface ICosmosCollection<TDocument> where TDocument : class
    {
        ...
        AsyncPageable<TDocument> GetItemQueryIteratorGetItemQueryIterator<T>(string queryText = null, string continuationToken = null, QueryRequestOptions requestOptions = null, CancellationToken cancellationToken = default);
